...
CREATE POLICY "Permitir leitura anonima de todos os produtos (DEBUG)" ON "public"."products" FOR SELECT TO "anon" USING (true);
...
CREATE POLICY "Super admins can read all products" ON "public"."products" FOR SELECT TO "authenticated" USING ((EXISTS ( SELECT 1
   FROM "public"."profiles"
