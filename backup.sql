...
BEGIN
    ...
    RETURN EXISTS (
        SELECT 1
        FROM auth.users
        WHERE id = auth.uid() AND email = 'usedonjuan@gmail.com' -- <<< IMPORTANT: REPLACE WITH YOUR SUPER_ADMIN_EMAIL
    );
END;
$$;
...
CREATE POLICY "Permitir Super Admin ler config da plataforma" ON "public"."platform_settings" FOR SELECT TO "authenticated" USING ((( SELECT "profiles"."is_super_admin"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"())) = true));



CREATE POLICY "Permitir atualização das configurações da plataforma por su" ON "public"."platform_settings" FOR UPDATE TO "authenticated" USING (("public"."is_current_user_the_super_admin"() AND ("id" = 'global'::"text"))) WITH CHECK (("public"."is_current_user_the_super_admin"() AND ("id" = 'global'::"text")));



CREATE POLICY "Permitir atualização do próprio perfil" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id")) WITH CHECK (("auth"."uid"() = "id"));
...
CREATE POLICY "Permitir deleção dos próprios produtos" ON "public"."products" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "Permitir inserção de produtos para si" ON "public"."products" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "platform_user_id"));



CREATE POLICY "Permitir inserção de vendas para o usuário logado" ON "public"."sales" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "platform_user_id"));



CREATE POLICY "Permitir inserção do próprio perfil" ON "public"."profiles" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "id"));



CREATE POLICY "Permitir leitura anonima de todos os perfis" ON "public"."profiles" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Permitir leitura anonima de todos os produtos" ON "public"."products" FOR SELECT TO "anon" USING (true);



CREATE POLICY "Permitir leitura das configurações da plataforma para super a" ON "public"."platform_settings" FOR SELECT TO "authenticated" USING (("public"."is_current_user_the_super_admin"() AND ("id" = 'global'::"text")));
...
CREATE POLICY "Permitir leitura do próprio perfil" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));
...
CREATE POLICY "Permitir leitura dos próprios produtos" ON "public"."products" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "Super Admins have full access to profiles" ON "public"."profiles" TO "authenticated" USING (("auth"."email"() = 'usedonjuan@gmail.com'::"text")) WITH CHECK (("auth"."email"() = 'usedonjuan@gmail.com'::"text"));
...
CREATE POLICY "Users can create their own products" ON "public"."products" FOR INSERT WITH CHECK (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "Users can delete their own products" ON "public"."products" FOR DELETE TO "authenticated" USING (("auth"."uid"() = "platform_user_id"));



CREATE POLICY "Users can insert their own products" ON "public"."products" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "Users can update their own products" ON "public"."products" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "platform_user_id")) WITH CHECK (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "Users can view their own products" ON "public"."products" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "platform_user_id"));
...
CREATE POLICY "permitir super adm atualizar plataforma" ON "public"."platform_settings" FOR UPDATE TO "authenticated" USING ((( SELECT "profiles"."is_super_admin"
   FROM "public"."profiles"
...
CREATE POLICY "permitir super adm ler logs" ON "public"."audit_logs" FOR SELECT TO "authenticated" USING ((( SELECT "profiles"."is_super_admin"
   FROM "public"."profiles"
  WHERE ("profiles"."id" = "auth"."uid"())) = true));
